...
folder_url <- "https://drive.google.com/drive/u/0/folders/1aAVaoQOBinW7n-01RIBSq_AFbKdthAqJ"
...
drive_download(as_id(files$id[5]),
               path = paste0("6.raw_data/", files$name[5]),
               overwrite = T)
